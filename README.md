...
1. В корне репозитория создать файл `.env` и призвоить переменной
`DJANGO_ALLOWED_HOSTS` необходимое значение. Например,

```
DJANGO_ALLOWED_HOSTS=localhost,127.0.0.1
```

2. Запустить shell-скрипт от имени привилигированного пользователя:
