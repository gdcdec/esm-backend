"""
Django settings for papo project.
...
# Настройки CORS (разрешаем запросы с других доменов)
...
# Или разрешить всё (потом убрать)
CORS_ALLOW_ALL_ORIGINS = True

# Настройки REST Framework
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # Разрешить всем (для начала)
    ],
...
# Who are the users?
AUTH_USER_MODEL = 'api.CustomUser' #Какая модель будет отвечать за пользователя
# Password validation
